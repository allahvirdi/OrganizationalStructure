...
/// <summary>
/// تست‌های یکپارچگی Endpointهای بارگذاری دسته‌جمعی پرسنل.
/// </summary>
public sealed partial class ImportEmployeesApiTests : IClassFixture<TestWebApplicationFactory>
{
    private readonly TestWebApplicationFactory _factory;
    private static int _sequence = 90000000;
    ...
    /// </summary>
    public ImportEmployeesApiTests(TestWebApplicationFactory factory)
    {
        _factory = factory;
    }
    ...
    private static ByteArrayContent CreateCsvContent(string text)
    {
