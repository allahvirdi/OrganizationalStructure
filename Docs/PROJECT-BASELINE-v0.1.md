...
|--------|-------------------------------------------|--------|-------|--------|----------------------------------------|-----------|---------|
| R-001  | نگاشت ۴ سطح سازمانی در نبود Region=3     | بالا   | بالا  | بالا   | هماهنگی مالک IAM برای افزودن Region=3 | Tech Lead | Open    |
...
|--------|-------------------------------------------|--------|----------------|-------------|---------|
| Q-001  | افزودن Region=3 به IAM                    | بالا   | مالک IAM       | فوری        | Open    |
| Q-002  | جزئیات پروتکل اتصال IAM (BFF/JWT)         | بالا   | Security/Tech  | فاز 1       | Open    |
| Q-003  | Schema نهایی جدول واسط Import             | متوسط  | Business       | Phase 7     | Open    |
| Q-004  | نحوه ثبت/تخصیص Permission دامنه‌ای در IAM | بالا   | مالک IAM       | فاز 1       | Open    |
